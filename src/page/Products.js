    ...
    return (
      <>
        <div className="bg-white">
          <div className="max-w-2xl mx-auto py-2 sm:py-2 sm:px-2 lg:max-w-6xl">
            <h1 className="text-2xl text-white rounded-full p-8 font-bold"></h1>
            <div className="grid grid-cols-1 gap-y-16 gap-x-6 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
              {products.map((prod) => (
                <Card data={prod} color="pink-500"/>
              ))}
            </div>
          </div>
