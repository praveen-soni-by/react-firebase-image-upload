...
export default function ProductUpload() {
  ...
  return (
    <div className="ml-2 h-screen md:flex w-full">
      {isLoading && <Loader />}
      {showAlert && (
        <div
          className="bg-green-600   absolute bottom-10 shadow-lg  right-10  border-l-4 border-green-500 text-white p-2"
          role="alert"
        >
      ...
      <div className=" w-full flex justify-center py-10 p-2 items-center bg-white">
            ...
            <div className="md:flex md:items-center">
              ...
              <div className="flex md:w-2/3 justify-center content-center">
                <button
                  ...
                  className="btn focus:shadow-outline focus:outline-none"
                  type="button"
                >
                  Upload
                </button>
